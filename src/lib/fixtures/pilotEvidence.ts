...
export const PILOT_EVIDENCE_CURRENT: PilotEvidenceSnapshot = {
  pilotId: "pilot-eg-gcc-001", snapshotId: "pilot-snapshot-002", alias: "EGYPT_GCC_FROZEN", observationWindow: "AUGUST_2026", readiness: "EVIDENCE_READY", freshness: "CURRENT", validatedEpisodes: 12, excludedEpisodes: 3, distinctCompanies: 8,
...
export const PILOT_EVIDENCE_NOT_REVIEWABLE: PilotEvidenceSnapshot = { ...PILOT_EVIDENCE_CURRENT, snapshotId: "pilot-snapshot-000", alias: "INSUFFICIENT_FROZEN", readiness: "NOT_REVIEWABLE", validatedEpisodes: 0, excludedEpisodes: 2, distinctCompanies: 0, regions: { Egypt: { numerator: 0, denominator: 0, excluded: 1, state: "INSUFFICIENT_REGIONAL_EVIDENCE" }, GCC: { numerator: 0, denominator: 0, excluded: 1, state: "INSUFFICIENT_REGIONAL_EVIDENCE" } } };
